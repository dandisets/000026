function[]=BaSiC_shading_and_ref_stitch(id,P2path, datapath, ntiles, depth, thickness,stitch, aip_threshold, Xoverlap, Yoverlap)
...
ref_tiles=zeros(ntiles,round(thickness*resize_factor),nx*resize_factor,ny*resize_factor,'single');
tic
for i=1:ntiles
    i
