function str1 = fun_learning_append_training_data(str1, str2)
...
if isfield(str1, 'data')
    ...
    warning('Filed data does not exist');
end
if isfield(str1, 'link_cc_ind')
    str1.link_cc_ind = [str1.link_cc_ind; str2.link_cc_ind];
else
    warning('Filed link_cc_ind does not exist');
end
